...
export default function InputForm({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (e) => {
    ...
    // If there's an uploaded image, include it in the prompt
    if (uploadedImage) {
      const imageInfo = `\n\n[Image uploaded: ${uploadedImage.public_url}]`;
      setPrompt(prompt + imageInfo);
    }
    ...
    <>
      ...
      <div className="border-t border-gray-200 p-6 flex-shrink-0 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          {uploadedImage && (
            <div className="mb-4 p-3 border border-gray-300 rounded-xl bg-gray-50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {uploadedImage.upload_error && (
                      <p className="text-xs text-orange-600">
                        Note: {uploadedImage.upload_error}
                      </p>
                    )}
                  </div>
                </div>
